/*
 * Adafruit GLCD 5x7 (TFT_eSPI font 1) — full 256-glyph table.
 * Source: Adafruit-GFX-Library glcdfont.c (BSD license).
 * Index: font[(uint8_t)ascii * 5 + column].
 */
#include "panel_font_glcd.h"

const uint8_t panel_font_glcd[1280] = {
...
{
	return &panel_font_glcd[(unsigned int)c * 5U];
}
